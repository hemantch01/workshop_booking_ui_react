...
export function Table({ className, children, ...props }) {
  return <div className="relative w-full overflow-auto"><table className={cn("w-full caption-bottom text-sm", className)} {...props}>{children}</table></div>;
}
...
export function TableRow({ className, children, ...props }) {
  return <tr className={cn("border-b border-border transition-colors hover:bg-muted/50", className)} {...props}>{children}</tr>;
}
